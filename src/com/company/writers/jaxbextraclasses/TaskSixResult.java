...
/**
 * Класс, описывающий результаты 6-го задания.
 */
@XmlRootElement(name = "task_six")
@XmlAccessorType(XmlAccessType.FIELD)
public class TaskSixResult extends TaskResult {
     ...
     */
    public TaskSixResult(Map<Good, Integer> map) {
