...
/**
 * Класс, описывающий результаты 7-го задания.
 */
@XmlRootElement(name = "task_seven")
@XmlAccessorType(XmlAccessType.FIELD)
public class TaskSevenResult extends TaskResult {
     ...
     */
    public TaskSevenResult(Map<LocalDate, Integer> map) {
